  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card title="Planning & Stratergy" icon={<AceternityIcon order="Phase 1"/>}
            description="I believe in a strategic approach to design, where every pixel serves a purpose. My process begins with understanding your goals and target audience, followed by meticulous planning to ensure a seamless user experience."
        ...
        <Card title="Development & Progress Update" icon={<AceternityIcon order="Phase 2"/>}
            description="With a solid plan in place, I dive into the development phase. I keep you updated on the progress, ensuring that the project aligns with your vision and expectations."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Development & Launch" icon={<AceternityIcon order="Phase 3"/>}
            description="The final phase involves rigorous testing to ensure everything functions flawlessly. Once approved, we launch your project, making it accessible to the world."
        >
          <CanvasRevealEffect
            animationSpeed={3}
